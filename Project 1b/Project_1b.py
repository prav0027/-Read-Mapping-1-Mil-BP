...
def takeOutErrorReads():
	...
	print("deletionsDict: ", deletionsDict.keys())
	print("substitutionsDict: ", substitutionsDict.keys())
	print("insertionsDict: ", insertionsDict.keys())
...
def save_results(fileName = 'predictions.csv'):
	f = open(fileName, 'w')
...
reads = read_reads('reads_large.txt')


reference = read_reference('genome_large.txt')
